...
<body class="body">
	<form action="/SpringMVC/members/memberAction/DM" method="post">
		<div class="form-register">
			<div class="panel panel-default">
			<div class="panel-body greybg">
		        <div class="panel-heading header"><h3 class="panel-title">Remove Member</h3></div><br>
		        ...
		        <div><input type="submit" value="Remove" class="btn btn-primary pull-right"></div>
		    </div>
		    </div>
		</div>
	  </form>
