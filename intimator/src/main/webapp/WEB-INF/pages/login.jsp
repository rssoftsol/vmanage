...
<form action="/SpringMVC/loginAction" method="post">
...
<tr><td></td><td>New club?click <a href="/SpringMVC/register">here</a> for registration</td></tr>
</table>
...
<div><span>New club?click <a href="/SpringMVC/register">here</a> for registration</span></div>
</div>
  --%>
 </form>
</body>
